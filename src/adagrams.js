...
export class Adagrams {
    ...
    static drawLetters() {
        ...
        while (hand.length < 10){
            randomLetter = Adagrams.randomSelectedLetter();
    ...
    //helper function
    static wordLetterDictObject(dataToConvert){
    ...
    static usesAvailableLetters(input, lettersInHand) {
        ...
        const dictWord = Adagrams.wordLetterDictObject(wordUpper);
        const dictLettersInHand = Adagrams.wordLetterDictObject(lettersInHand);
